...
public_router.register(r'public/image/category', PublicImageCategoryViewset, basename="image-category")
...
private_router.register(r'private/district', PrivateDistrictViewset, basename='private-district')
private_router.register(r'private/neighbourhood', PrivateNeighbourhoodViewset, basename='private-neighbourhood')
private_router.register(r'private/postcode', PrivatePostCodeViewset, basename='private-postcode')
