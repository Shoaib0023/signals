...
SITE_DOMAIN = os.getenv('SITE_DOMAIN', 'ec2-52-200-189-81.compute-1.amazonaws.com')
...
SIGNALS_AUTHZ = {
    ...
    'JWKS_URL': 'http://ec2-52-200-189-81.compute-1.amazonaws.com:5556/keys',
...
RABBITMQ_HOST = 'ec2-52-200-189-81.compute-1.amazonaws.com'
...
SEARCH = {
    'PAGE_SIZE': 500,
    'CONNECTION': {
        'HOST': os.getenv('ELASTICSEARCH_HOST', 'ec2-52-200-189-81.compute-1.amazonaws.com:9200'),
